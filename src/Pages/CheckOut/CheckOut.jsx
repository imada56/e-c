    ...
    <section className='min-h-[320px] mt-[140px]'>
     <div className='container m-auto'>
      <div className='font-extralight  felx justify-around md:w-[80%] m-auto px-4 md:px-10 my-6'>
        <a className='hover:font-semibold' href="">Account  </a><span> / </span>
        <a className='hover:font-semibold' href="">My Account </a><span> / </span>
        <a className='hover:font-semibold' href="">Product </a><span> / </span>
        <a className='hover:font-semibold' href="">View Cart </a><span> / </span>
        <a className='hover:font-semibold' href="">CheckOut</a>
      </div>
      ...
      <div className=' container m-auto  md:w-[80%] flex justify-around'>
        ...
        <h1 className=' font-bold'>Billing Details</h1>
            <form   className='flex flex-col gap-2 mt-2 ' action="">
                <label className='font-extralight' htmlFor="">First Name*</label>
                <input className='bg-[#F5F5F5] border-2' type="text" />
                <label className='font-extralight' htmlFor="">Company Name</label>
                <input className='bg-[#F5F5F5] border-2' type="text" />
                <label className='font-extralight' htmlFor="">Street Address*</label>
                <input className='bg-[#F5F5F5] border-2' type="text" />
                <label  className='font-extralight' htmlFor="">Apartment, floor, etc. (optional)</label>
                <input className='bg-[#F5F5F5] border-2' type="text" />
                <label className='font-extralight' htmlFor="">Town/City*</label>
                <input className='bg-[#F5F5F5] border-2' type="text" />
                <label className='font-extralight'htmlFor="">Phone Number*</label>
                <input className='bg-[#F5F5F5] border-2' type="text" />
                <label  className='font-extralight'htmlFor="">Email Address*</label>
                <input className='bg-[#F5F5F5] border-2 'un type="text" />
                <div className=''>
        ...
        <div className='w-[35%] flex flex-col gap-1 py-6 '>
           ...
           <div className=' flex w-[100%] justify-between items-center px-2  '>
                <div className=' flex  gap-2 items-center mr-3  w-[15%] md:w-[7%]  '>
                <img className=' object-contain h-[20%] ' src={g1} alt="" />
            ...
            <div className=' flex w-[100%] justify-between items-center px-2  '>
                ...
                <img className=' object-contain h-[20%] ' src={img63} alt="" />
                 <p className='text-xs md:text-base '>CDM Manet</p>
                 </div>
                <p className='text-sm md:text-base'>#390</p>
            </div>
            <div className=' flex w-[100%] justify-between items-center px-2  '>
                <div className=' flex  gap-2 items-center mr-3  w-[15%] md:w-[7%]  '>
                <img className=' object-contain h-[20%] ' src={g2} alt="" />
                 <p className='text-xs md:text-base '>Product</p>
                 </div>
                <p className='text-sm md:text-base'>#390</p>
            </div>
          ...
          <div className=' h-[5%] items-center px-2 flex justify-between'>
            ...
            <div className='flex gap-1 px-2'>
              ...
              <div className=' flex flex-col gap-1 md:flex-row md:justify-between px-2 w-[100%]'>
                <input type="search" className='border-2 text-sm md:text-base py-2 px-3  md:w-[55%]' name="" id="" placeholder='Coupon Code'/>
                <button className='md:w-[40%] px-2 py-2  text-sm md:text-base border-2 text-white  bg-red-500'> Apply Coupon</button>
            </div> 
            <button className='md:w-[40%] mx-2 text-sm md:text-base px-2 py-2 border-2 text-white  bg-red-500'> Apply Coupon</button>
