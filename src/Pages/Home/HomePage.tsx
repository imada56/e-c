...
const HomePage:React.FC<HomePageProps>= ({
  ...
  return (
    <div className='' >
      ...
      <div className='w-[85%] container flex   flex-col gap-4 m-auto mt-32'>
          ...
          <div className=' flex gap-2 min-h-[300px] justify-center'>
            ...
            <div className=' w-[33%] flex flex-col gap-2  '>
              ...
              <div className=' bg-[#0D0D0D] px-2 w-[100%]  md:h-[46%] flex relative'>
                <div className='absolute bottom-1 w-[90%] md:w-[40%] '>
                <h1 className='text-white text-xs font-semibold '> Women’s Collections</h1>
                <p className='text-white text-xs '>Featured woman collections that give you another vibe.</p>
                <a className='text-white text-xs md:text-sm underline' href="">Shop Now</a>
                </div>
